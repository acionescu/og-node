 ...
 */
package net.segoia.ogeg.services.status.events;

import net.segoia.event.eventbus.CustomEvent;
import net.segoia.event.eventbus.EventType;
import net.segoia.ogeg.services.status.StatusAppModel;
import net.segoia.ogeg.services.status.events.StatusAppInitEvent.Data;
